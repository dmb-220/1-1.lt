...
Į įrašų skaičių patenka nurašymai, pajamavimas, kiti tarpiniai įrašai, reikalingi teisingos bugalterijos tvarkymui.</small></h5></td></tr>";}
...
o verslo reikmėms nuo pirmo tokio vieneto gamintojas arba importuotojas turi registruotis Gamintojų ir importuotojųsąvade, organizuoti surinkimą, vežimą, pasiruošimą naudoti, 
...
.</small></h5></td></tr>";}
                ...
                if($data['zemes_mokestis'] =="on"){
                    ...
                    echo"<tr><td class='text-left' colspan='4'><h5><small>Nuo 2018-01-01 mokant žemės mokestį, ūkininkas privalo išskaičiuoti gyventojų pajamų mokestį, sumokėti ir deklaruoti VMI.</small></h5></td></tr>";}
...
Šis sąskaitų planas programuotojų apmokestinamas.</small></h5></td></tr>";}
                ...
                if($data['kuras'] == "on" && $data['kuras_kiekis'] > 0){
                    ...
                    echo"<tr><td class='text-left' colspan='4'><h5><small>Kuro apskaita vykdome, jei įtraukiami į apskaitą visų rušių degalai. 
Pildomi kelionės lapai kiekvienai transporto priemonei. </small></h5></td></tr>";}
            ...
            <table class="table table-bordered">
                ...
                if($data['laiku_atsiskaito'] == "on"){echo"Laiku atsiskaito: ( 1% )<br>";}
                if($data['seimos_nariai'] == "on"){echo"Šeimos nariai veda apskaitą: ( 1% )";}
                echo"</td>
