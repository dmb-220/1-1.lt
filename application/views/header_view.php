<div class="row border-bottom">
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom" action="<?= base_url(); ?>main/paieska">
                <div class="form-group">
                    <input type="text" placeholder="Ieškoti .." class="form-control" name="top-search" id="top-search">
                </div>
            </form>
        </div>
