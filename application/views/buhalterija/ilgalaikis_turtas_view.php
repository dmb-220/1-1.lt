<div id="ilg_turtas" class="tab-pane in active" xmlns="http://www.w3.org/1999/html">
    <div class="panel-body">
        ...
        <div id="pradiniai_likuciai_show"  style="display:none">
            ...
            $turto_rusys = array(
                ...
                "Baldai ir inventorius",
                "Kompiuterinė technika",
                "Mobiliojo ryšio priemonės",
                "Lengvieji automobiliai",
                "Kiti lengvieji auto. ( nauji iki 5 m.)",
                ...
                <fieldset>
                    ...
                    <div class="form-group row">
                        <div class="col-xs-4">
                            ...
                            <input class="form-control" id="grupe" name="grupe" type="text">
                        </div>
                        <div class="col-xs-5">
            ...
            <form class="form-bordered" action="<?= base_url(); ?>buhalterija/pradiniai_likuciai" method="POST">
                <fieldset>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-4">
                            <label for="sukauptas_nusidevejimas">Sukauptas nusidėvėjimas:</label>
                            <input class="form-control" id="sukauptas_nusidevejimas" name="sukauptas-nusidevejimas" type="text">
                        </div>
                        <div class="col-xs-3">
                            <label for="deklaruojamoji_verte">Deklaruojamoji vertė:</label>
                            <input class="form-control" id="deklaruojamoji_verte" name="deklaruojamoji_verte" type="text">
